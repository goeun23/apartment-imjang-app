  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const record = await createRecord({
        ...
        ltv_rate: formData.is_ltv_regulated
          ? formData.ltv_rate
          : (70 as 40 | 70), // Default if not regulated, though logic might need adjustment
        memo: formData.memo,
        // Optional fields
      ...
      <form onSubmit={handleSubmit} className="px-4 py-6 space-y-6">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, apartment_name: e.target.value })
            }
        ...
        <div>
          ...
          <AreaChipSelector
            ...
            onChange={(area_pyeong) =>
              setFormData({ ...formData, area_pyeong })
            }
          />
        </div>
        ...
        <div>
          ...
          <StarRating
            ...
            onChange={(school_accessibility) =>
              setFormData({ ...formData, school_accessibility })
            }
          />
        </div>
          ...
          <div className="flex gap-3">
            {[
              ...
              <button
                ...
                type="button"
                onClick={() =>
                  setFormData({ ...formData, is_ltv_regulated: option.value })
                }
                className={`flex-1 py-3 px-4 rounded-lg font-medium transition-all ${
